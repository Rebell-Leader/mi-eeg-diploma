...
class DataBuildClassifier(Data):
    def __init__(self, path_to_data):
        ...
        '''
        start_epoch = -1  # -0.5 #seconds
        end_epoch = 0.5  # 1 #seconds
    ...
    def get_data(self, subjects, shuffle=True, windows=None, baseline_window=()):
        ...
        for subject in subjects:
            ...
            rawData = loadmat(os.path.join(self.path_to_data, str(subject), 'EVG.mat'))
            tmp = rawData['epobss']
            eegT = tmp[0, 0]['count']
            eegNT = tmp[0, 0]['find']
...
if __name__ == '__main__':
    data = DataBuildClassifier('data').get_data([33], shuffle=True,
